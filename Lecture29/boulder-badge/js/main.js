...
let caterpiesCandies = 7 - 1
let weedleCandies = 7 - 1

let totalCandies = bulbasaurCandies + caterpiesCandies + weedleCandies
...
// undergroundPokemonLeague(2)
undergroundPokemonLeague(['bulbasaru', 'caterpie', 'weedle'])
